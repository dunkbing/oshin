...
enum ACPMessage: Codable, Sendable {
...
enum RequestId: Codable, Hashable, CustomStringConvertible, Sendable {
    case string(String)
    case number(Int)
...
struct AnyCodable: Codable {
    ...
    func encode(to encoder: Encoder) throws {
        if let encodable = value as? Encodable, !(value is AnyCodable) {
            try AnyEncodable(encodable).encode(to: encoder)
            return
        }
