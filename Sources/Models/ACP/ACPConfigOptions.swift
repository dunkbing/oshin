...
struct SessionConfigOption: Codable, Sendable {
...
struct SessionConfigId: Codable, Hashable, Sendable {
    let value: String
...
struct SessionConfigValueId: Codable, Hashable, Sendable {
    let value: String
...
enum SessionConfigKind: Codable, Sendable {
...
struct SessionConfigSelect: Codable, Sendable {
...
enum SessionConfigSelectOptions: Codable, Sendable {
...
struct SessionConfigSelectOption: Codable, Sendable {
...
struct SessionConfigGroupId: Codable, Hashable, Sendable {
    let value: String
...
struct SessionConfigSelectGroup: Codable, Sendable {
    ...
    init(from decoder: Decoder) throws {
        ...
        group =
            try container.decodeIfPresent(SessionConfigGroupId.self, forKey: .group)
            ?? SessionConfigGroupId(self.name)
