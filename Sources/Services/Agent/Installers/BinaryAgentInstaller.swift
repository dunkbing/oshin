...
actor BinaryAgentInstaller {
    ...
    func install(from urlString: String, agentId: String, targetDir: String) async throws {
        ...
        if isTarball {
            try await extractTarball(
                from: tempFileURL, url: urlString, agentId: agentId, targetDir: targetDir)
        } else if isZip {
    ...
    private func extractTarball(
        from tempFileURL: URL, url: String, agentId: String, targetDir: String
    ) async throws {
    ...
    private func installDirectBinary(from tempFileURL: URL, agentId: String, targetDir: String)
        throws
    {
